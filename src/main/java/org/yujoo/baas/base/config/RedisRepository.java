...
//    }
	...
	{
		Double score1=new Double(value1);
		Double score2=new Double(value2);
		long result=redisTemplate.opsForZSet().count(key, score1, score2);
		return  Integer.parseInt(String.valueOf(result)); 
	
		
	}
	
	public int  operateZsetRevrank(String key, Object value)
	{
	...
	public Set<String> operateZsetRevrange(String key,int value1,int value2)
	{
